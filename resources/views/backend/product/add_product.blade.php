        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('dashboard.product.storee') }}" method="POST"  enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3 mt-5">
                            ...
                            <div class="col-sm-10">
                                <input type="text" placeholder="product name" name="name" class="form-control" id="inputText">
                            </div>
                            @error('name')
                        ...
                        <div class="row mb-3 mt-5">
                            ...
                            <div class="col-sm-10">
                                <input type="text" placeholder="product quantity" name="quantity" class="form-control" id="inputText">
                            </div>
                            @error('quantity')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="row mb-3 mt-5">
                            ...
                            <div class="col-sm-10">
                                <input type="text" placeholder="product price" name="price" class="form-control" id="inputText">
                            </div>
                            @error('price')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="row mb-3 mt-5">
                            ...
                            <div class="col-sm-10">
                                <input type="text" placeholder="product sale_price" name="sale_price" class="form-control" id="inputText">
                            </div>
                            @error('sale_price')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="row mb-3 mt-5">
                            ...
                            <div class="col-sm-10">
                                <textarea placeholder="product desc" name="desc" class="form-control" id="inputText"></textarea>
                            </div>
                            @error('desc')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
